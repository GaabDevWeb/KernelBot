    ...
    def build_prompt_block(
        ...
        *,
        ...
        rules = (
            ...
            "responda primeiro com a secção **Hoje** abaixo; inclua também **Hoje — aulas "
            "síncronas (horário semanal recorrente)** quando existir — a grade Zoom semanal "
            "conta como aula agendada mesmo sem evento datado no calendário FIAP.\n"
