# Assessment — Fundamentos de Desenvolvimento com Java [26E3_1]
...
- **Atividade:** [Assessment (Obrigatório)](https://lms.infnet.edu.br/moodle/mod/assign/view.php?id=471849)
- **Tipo:** Tarefa (código-fonte + prints, PDF)
- **Data de entrega:** terça, 22 set 2026, 23:59
- **Tentativas:** 2 permitidas
- **Nome do arquivo:** `nome_sobrenome_DR1_AT.PDF`
- **Status observado:** nenhuma tentativa
...
Formato: Código-fonte e prints das saídas do programa.
Critérios: Organização, funcionamento correto, boas práticas e compreensão dos conceitos.

Boa sorte!

Assim que terminar, salve seu trabalho em PDF nomeando o arquivo conforme a regra “nome_sobrenome_DR1_AT.PDF” e poste como resposta a este AT.
...
4. Utilizar os pilares do paradigma de orientação ao objeto para criação de programas em Java  
O aluno executou corretamente 25% dos exercícios da lista proposta? **25%**
...
5. Escrever programas em Java com arrays, coleções, arquivos e recursos mais avançados  
O aluno executou corretamente 25% dos exercícios da lista proposta? **25%**
