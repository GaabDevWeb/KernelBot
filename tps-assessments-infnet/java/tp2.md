# TP2 — Fundamentos de Desenvolvimento com Java [26E3_1]

- **Disciplina:** Fundamentos de Desenvolvimento com Java [26E3_1]
- **Curso Moodle:** [26T3-ADS-R1C1N2L1-DVBE-L1](https://lms.infnet.edu.br/moodle/course/view.php?id=10021)
- **Atividade:** [Teste de Performance - TP2 (Obrigatório)](https://lms.infnet.edu.br/moodle/mod/assign/view.php?id=471847)
- **Tipo:** Tarefa (entrega em PDF)
- **Data de entrega:** segunda, 24 ago 2026, 23:59
- **Nome do arquivo:** `nome_sobrenome_DR1_TP2.PDF`
- **Status observado:** nenhuma tentativa / atrasado
...
Assim que terminar, salve seu trabalho em PDF nomeando o arquivo conforme a regra “nome_sobrenome_DR1_TP2.PDF” e poste como resposta a este TP.

## Rubrica

Níveis de cada item: **Não demonstrou o item de rubrica** / **Demonstrou o item de rubrica**.

2. Escrever programas em Java usando seus elementos básicos  
